...
import Game.Gameplay.MultiPlayer;
 ...
 * MiniGolfv1_2
 */
public class mpDialog implements Screen{
    protected MiniGolfExecutor game;
    private Stage stage;
    private int hits;
    private int winner;

    public mpDialog (final MiniGolfExecutor game, int hits,int winner){
        this.game = game;
        this.hits = hits;
        this.winner = winner;
        initializeMPdialog();
    ...
    public void initializeMPdialog(){
        stage = new Stage(new ScreenViewport());
        Skin skin = new Skin(Gdx.files.internal(PathUtil.assetsPath()+"uiskin.json"));

        Label textButton;
        textButton = new Label("Player" + winner + " won with " + hits + " hits", skin, "default");
